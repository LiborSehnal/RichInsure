...
SECRET_KEY = 'django-insecure-bzzmt3y03iv(j-s*a2yw*b2a5m=8i00wv=ao3n#8o#uqhk_xxr'
...
EMAIL_RECEIVING_USER = ['libor.sehnal@gmail.com'] # email on which you will receive messages sent from website
